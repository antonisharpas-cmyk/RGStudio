...
export const en = {
  ...
  desk: {
    ...
    teamHelp:
      "Whoever is listed here, and switched on, appears on the studio page and can be put on a class. Removing somebody hides them from the site; their past classes keep their name.",
...
export const el: typeof en = {
  ...
  desk: {
    ...
    teamHelp:
      "Όποιος είναι εδώ, και ενεργός, εμφανίζεται στη σελίδα του στούντιο και μπορεί να μπει σε μάθημα. Η αφαίρεση τον κρύβει από τη σελίδα· τα περασμένα μαθήματα κρατούν το όνομά του.",
