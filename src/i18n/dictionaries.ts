/* ru.ts imports only the *type* of `en` from here, so the cycle is erased at
   compile time and this import is safe at the top. */
import { ru } from "./ru";
...
export const en = {
  meta: {
    ...
    description:
      "Reformer Pilates in Larnaca. Small groups, sixty minute sessions, expert coaching. Embrace your uniqueness: buy a session pack and book your classes online.",
  },
  nav: {
    home: "Home",
    studio: "Studio",
  ...
  common: {
    ...
    credits: "sessions",
    credit: "session",
    /* The "few" plural form (2 to 4 in Russian). English and Greek have no
       such form, so it repeats the plural; LanguageProvider picks it through
       Intl.PluralRules. */
    creditsFew: "sessions",
  ...
  home: {
    hero: {
      ...
      word: "Pilates",
      subtitle:
        "Small group Reformer Pilates in a calm, light filled room. Precise coaching, sixty minute sessions, and a body that moves better every week.",
    ...
    equipment: {
      eyebrow: "The room",
      title: "Find your balance, own your strength.",
      specReformers: "Reformers",
      specReformersValue: "{n} in the room",
      specSession: "Session",
      specSessionValue: "{minutes} minutes",
      body: "Every reformer in the room is new, quiet and precisely sprung, and every class is capped at the number of reformers, so nobody waits and nobody is lost in a crowd. Sixty minutes, one instructor beside you, and a room that feels the same on your first class as on your hundredth.",
      points: [
        "New reformers with precisely calibrated springs",
        "Small classes, so every position is seen and corrected",
        "Sixty minute sessions, morning and evening, six days a week",
      ],
    },
    classes: {
      eyebrow: "Class types",
      title: "Find your level.",
      body: "Every class is sixty minutes on the reformer and costs one session, so choose by intention rather than by price.",
    ...
    timetable: {
      ...
      personalLabel: "Personal & Duet, Monday to Thursday",
  ...
  studio: {
    equipmentLine: "Reformer · {n} per class · {minutes} minutes",
    hero: {
      eyebrow: "The studio",
      title: "A room built for attention.",
      body: "Soft light and warm wood. A handful of reformers, one instructor, sixty minutes that belong entirely to how you move.",
    },
    sections: [
      {
        t: "Capped classes",
        d: "One person per reformer, and no more people than reformers. That means real hands on correction rather than a crowd following a routine. Your instructor knows your springs, your restrictions and your goal.",
      },
      {
        t: "New reformers throughout",
        d: "Every reformer in the room is new, quiet and consistent. The same resistance at 06:00 and at 19:00, and beautiful to use.",
      },
      {
      ...
      },
      {
        ...
        d: "Between the morning and evening rota the studio keeps three slots free for Personal and Duet sessions, at 12:00, 13:00 and 14:00, Monday to Thursday. Book by the end of the day before and an instructor is there for you. A Duet is the same session for two, bought and booked by one of you.",
      },
    ],
    room: {
      eyebrow: "In the room",
  ...
  classesPage: {
    hero: {
      ...
      body: "Every class on the timetable runs sixty minutes and costs a single session. Move between formats as your body and week demand.",
    },
    levelLabel: "Level",
  ...
  pricingPage: {
    ...
    groups: {
      ...
      personal: {
        ...
        note: "An hour at 12:00, 13:00 or 14:00, Monday to Thursday, with an instructor to yourself. A Duet is the same hour shared with one other person.",
      },
    },
    ...
    includes: [
      "Sixty minute Reformer class on new equipment",
      "Small classes, never more people than reformers",
      "Free cancellation up to 12 hours before a class",
      "Personal and Duet sessions at 12:00, 13:00 and 14:00, Monday to Thursday",
    ],
  ...
  plans: {
    ...
    title: "Commit for longer, pay month by month.",
    body: "Choose how long and how often. Every session in the term is on your account from day one, so you can book your regular hours for the whole term, and you pay the monthly price as you go.",
    months: "How long",
    monthsN: "{n} months",
    perWeek: "How often",
    perWeekOne: "1 class a week",
    perWeekMany: "{n} classes a week",
    perMonth: "{amount} per month",
    total: "{n} sessions over the term",
    firstMonth: "Pay the first month today, then the same amount every month.",
    rule: "If a month is not paid within {days} days of its due date, your upcoming bookings are released for other members and your sessions pause until the month is paid. Nothing is lost.",
    cta: "Start this plan",
    signIn: "Sign in to start a plan",
    unavailable: "This combination is not available right now.",
  },
  plan: {
    title: "Monthly plan",
    name: "{months} months · {perWeek} a week",
    monthOf: "Month {n} of {total}",
    paidThrough: "Paid up to {date}",
    dueOn: "Next payment due {date}",
    payBy: "Pay by {date} to keep your bookings",
    paused: "Paused: this month is unpaid, your sessions are frozen and your upcoming bookings were released. Pay the month to open everything again.",
    completed: "Term finished",
    cancelled: "Plan ended",
    pay: "Pay this month",
    sessionsLeft: "{n} sessions left on the plan",
    checkoutFirst: "First month of your plan",
    checkoutRenew: "Month {n} of {total} on your plan",
    checkoutTerm: "{months} months · {n} sessions in total",
    checkoutNote: "The same amount is due every month. You can pay online here or at the studio.",
  },
  desk: {
    ...
    /* ---- packs, managed here ---- */
    packTitle: "Packs on sale",
    packHelp:
      "Every pack the studio sells: its name, how many sessions, how many days they last and the list price. Switch a pack off to take it off the pricing page; members who bought it keep what they have.",
    packNew: "New pack",
    packNameEn: "Name (English)",
    packNameEl: "Name (Greek)",
    packSessions: "Sessions",
    packDays: "Valid for (days)",
    packPrice: "Price (€)",
    packGroup: "Heading on the pricing page",
    packGroupSingle: "One at a time",
    packGroupMonth: "1 Month",
    packGroupQuarter: "3 Months",
    packGroupPersonal: "Personal and Duet",
    packOn: "On sale",
    packOff: "Off sale",
    packSwitchOn: "Put on sale",
    packSwitchOff: "Take off sale",
    packDelete: "Delete",
    packDeleteAsk: "Delete {name} for good? This cannot be undone.",
    packDeleteYes: "Yes, delete",
    ...
    planHelp:
      "A long term paid one month at a time. All sessions go on the account today; the monthly price is the one month pack for that cadence. If a month is not paid within 3 days the plan pauses and its bookings are released.",
    planNone: "No plan. Start one below, with the first month paid at the desk.",
    planStart: "Start plan",
    planMonths: "Months",
    planPerWeek: "Classes a week",
    planMethod: "Paid by",
    planCash: "Cash",
    planCard: "Card at the desk",
    planRecord: "Record this month's payment",
    planCancel: "End the plan",
    planStarted: "{name}: plan started, {n} sessions added.",
    planPaid: "{name}: month {n} of {total} recorded.",
    planCancelled: "{name}: plan ended.",
    planAllPaid: "Every month of this plan is paid.",
    planAlready: "This member already has a plan.",
    planStatusActive: "Active",
    planStatusLapsed: "Paused, unpaid",
    planStatusPending: "Waiting for first payment",
    planStatusCancelled: "Ended",
    planStatusCompleted: "Finished",
    planOwing: "A month is owed",
    teamTitle: "Instructors",
    teamHelp:
      "Whoever is listed here, and switched on, appears on the studio page and can be put on a class. Hide takes somebody off the site and keeps their name on past classes. Delete removes them for good; their classes stay on the timetable without an instructor until you assign one.",
    teamAdd: "Add an instructor",
    teamEdit: "Edit",
    teamName: "Name",
    ...
    teamDeleteAsk: "Delete {name} for good? Their classes stay on the timetable without an instructor.",
    teamDeleteYes: "Yes, delete",
    ...
    extendTitle: "Extend expiry",
    extendHelp:
      "Give a member more time to use the sessions they already hold. Pick the batch and how many extra days; the new date is shown before you press.",
    extendBatch: "{left} of {total} left · expires {date}",
    extendNoExpiry: "no expiry",
    extendDays: "Extra days",
    extendDo: "Extend",
    extendDone: "{name}: sessions now expire on {date}.",
    extendNone: "This member holds no sessions with an expiry date.",
    /* ---- base prices ---- */
    priceBaseTitle: "List prices",
    priceBaseHelp:
      "The normal price of each pack, before any offer. Change a number and save; the pricing page, checkout and invoices all follow it.",
    priceBaseDo: "Save price",
    priceBaseDone: "Price saved. The price list has changed everywhere.",
    priceBaseEdited: "set at the desk",
    priceBaseReset: "Back to the original price",
    /* ---- promo codes ---- */
    promoTitle: "Promo codes",
    promoHelp:
      "A code a member types at checkout for a discount. Each code can be switched on and off, and can be limited to a date range and a number of uses.",
    promoCode: "Code",
    promoKind: "Discount",
    promoValue: "Amount",
    promoFrom: "Valid from",
    promoUntil: "Valid until",
    promoMaxUses: "Maximum uses",
    promoMaxUsesHelp: "Leave empty for no limit",
    promoCreate: "Create code",
    promoCreated: "Code created.",
    promoActive: "Active",
    promoInactive: "Switched off",
    promoScheduled: "Not started yet",
    promoExpired: "Expired",
    promoUsedUp: "Used up",
    promoEnable: "Switch on",
    promoDisable: "Switch off",
    promoDelete: "Delete",
    promoDeleted: "Code deleted.",
    promoNone: "No promo codes yet.",
    promoUses: "{n} uses",
    promoExists: "That code already exists.",
    promoBad: "Check the code and the amount.",
  ...
  auth: {
    ...
    forgotBody: "Type the email you registered with and we will send you a link to choose a new one.",
    forgotCta: "Send me the link",
    forgotSentTitle: "Check your inbox.",
    forgotSentBody: "If that address has an account with us, an email with a link is on its way. The link works once and expires in {n} minutes. If nothing arrives, check your spam folder or try again.",
    forgotNotSent: "We could not send the email just now. Please try again in a moment, or contact the studio.",
    resetTitle: "Choose a new password.",
    resetBody: "At least 8 characters. You will use it the next time you sign in.",
    ...
    resetDoneBody: "You can sign in with it now.",
    resetInvalidTitle: "This link no longer works.",
    resetInvalid: "This link is not valid. Please ask for a new one.",
    resetExpired: "This link has expired. Links work for {n} minutes.",
    resetUsed: "This link has already been used. If you did not change your password, ask for a new link.",
  ...
  checkoutPage: {
    ...
    promoInvalid: "That code is not valid for this pack right now.",
    promoRemove: "Remove",
    testTitle: "Test mode",
    testBody:
  ...
  footer: {
    tagline: "Reformer Pilates in Larnaca.",
    explore: "Explore",
    account: "Account",
    visit: "Visit",
    legal: "Legal",
    ...
    partner: "Strength · Flexibility · Core",
  ...
  intake: {
    ...
    conditionPlaceholder:
      "For example: lower back pain, a knee that does not like deep flexion, six weeks after giving birth.",
...
export const el: typeof en = {
  meta: {
    title: "RG Pilates Studio · Reformer Pilates στη Λάρνακα",
    description:
      "Reformer Pilates στη Λάρνακα. Μικρά γκρουπ, εξηντάλεπτα μαθήματα, εξειδικευμένη καθοδήγηση. Αγόρασε πακέτο και κλείσε τα μαθήματά σου online.",
  },
  nav: {
    home: "Αρχική",
    studio: "Στούντιο",
  ...
  common: {
    ...
    spotsLeftFew: "θέσεις διαθέσιμες",
    full: "Πλήρες",
  ...
  home: {
    hero: {
      ...
      word: "Pilates",
      subtitle:
        "Reformer Pilates σε μικρά γκρουπ, σε έναν ήρεμο, φωτεινό χώρο. Ακριβής καθοδήγηση, εξηντάλεπτα μαθήματα και ένα σώμα που κινείται καλύτερα κάθε εβδομάδα.",
    ...
    method: {
      eyebrow: "Η μέθοδος",
      title: "Ανάπνευσε. Ευθυγράμμισε. Ανέβα.",
      items: [
        {
          k: "01",
          t: "Αναπνοή",
    ...
    equipment: {
      eyebrow: "Η αίθουσα",
      title: "Βρες την ισορροπία σου, κατάκτησε τη δύναμή σου.",
      ...
      specReformers: "Reformers",
      specReformersValue: "{n} στην αίθουσα",
      specSession: "Μάθημα",
      specSessionValue: "{minutes} λεπτά",
      body: "Κάθε reformer στην αίθουσα είναι καινούργιος, αθόρυβος και με ακριβή ελατήρια, και κάθε μάθημα έχει τόσες θέσεις όσοι και οι reformers, ώστε κανείς να μην περιμένει και κανείς να μη χάνεται στο πλήθος. Εξήντα λεπτά, ένας εκπαιδευτής δίπλα σου, και ένας χώρος που νιώθεις ίδιο στο πρώτο και στο εκατοστό μάθημα.",
      points: [
        "Καινούργιοι reformers με ακριβή βαθμονόμηση ελατηρίων",
        "Μικρά μαθήματα, ώστε κάθε θέση να βλέπεται και να διορθώνεται",
        "Εξηντάλεπτα μαθήματα, πρωί και απόγευμα, έξι ημέρες την εβδομάδα",
      ],
    },
    classes: {
      eyebrow: "Τύποι μαθημάτων",
      title: "Βρες το επίπεδό σου.",
      body: "Κάθε μάθημα διαρκεί εξήντα λεπτά και κοστίζει μία συνεδρία, οπότε επίλεξε με βάση τον στόχο και όχι την τιμή.",
    ...
    timetable: {
      ...
      weekday: "Δευτέρα έως Παρασκευή",
      personalLabel: "Ατομικές & Δυάδες, Δευτέρα έως Πέμπτη",
      personalHours: "12:00 · 13:00 · 14:00",
  ...
  studio: {
    equipmentLine: "Reformer · {n} ανά μάθημα · {minutes} λεπτά",
    hero: {
      eyebrow: "Το στούντιο",
      title: "Ένας χώρος φτιαγμένος για προσοχή.",
      body: "Απαλό φως και ζεστό ξύλο. Λίγοι reformers, ένας εκπαιδευτής, εξήντα λεπτά που ανήκουν αποκλειστικά στο πώς κινείσαι.",
    },
    sections: [
      {
        t: "Περιορισμένες θέσεις",
        d: "Ένα άτομο ανά reformer, και ποτέ περισσότερα άτομα από reformers. Αυτό σημαίνει πραγματική διόρθωση αντί για ένα πλήθος που ακολουθεί μια ρουτίνα. Ο εκπαιδευτής ξέρει τα ελατήριά σου, τους περιορισμούς σου και τον στόχο σου.",
      },
      {
        t: "Καινούργιοι reformers παντού",
        d: "Κάθε reformer στην αίθουσα είναι καινούργιος, αθόρυβος και σταθερός. Η ίδια αντίσταση στις 06:00 και στις 19:00, και άψογη αίσθηση.",
      },
      {
      ...
      {
        t: "Ο χώρος δικός σου",
        d: "Ανάμεσα στο πρωινό και στο απογευματινό πρόγραμμα, το στούντιο κρατάει τρεις ώρες ελεύθερες για Ατομικές και Δυάδες, στις 12:00, 13:00 και 14:00, Δευτέρα έως Πέμπτη. Κάνε κράτηση μέχρι το τέλος της προηγούμενης μέρας και θα υπάρχει εκπαιδευτής για εσένα. Μια Δυάδα είναι η ίδια συνεδρία για δύο, με αγορά και κράτηση από τον ένα από τους δύο.",
      },
    ],
    room: {
  ...
  classesPage: {
    hero: {
      ...
      body: "Κάθε μάθημα στο πρόγραμμα διαρκεί εξήντα λεπτά και κοστίζει μία συνεδρία. Άλλαξε μορφή ανάλογα με το σώμα και την εβδομάδα σου.",
    },
    levelLabel: "Επίπεδο",
  ...
  pricingPage: {
    ...
    includes: [
      "Εξηντάλεπτο μάθημα Reformer σε καινούργιο εξοπλισμό",
      "Μικρά μαθήματα, ποτέ περισσότερα άτομα από reformers",
      "Δωρεάν ακύρωση έως 12 ώρες πριν από το μάθημα",
      "Ατομικές και Δυάδες στις 12:00, 13:00 και 14:00, Δευτέρα έως Πέμπτη",
    ],
  ...
  plans: {
    ...
    title: "Δέσμευση για περισσότερο, πληρωμή μήνα με μήνα.",
    body: "Διάλεξε για πόσο και πόσο συχνά. Κάθε συνεδρία της περιόδου είναι στον λογαριασμό σου από την πρώτη μέρα, ώστε να κλείσεις τις σταθερές ώρες σου για όλη την περίοδο, και πληρώνεις τη μηνιαία τιμή στην πορεία.",
    months: "Για πόσο",
    monthsN: "{n} μήνες",
    perWeek: "Πόσο συχνά",
    perWeekOne: "1 μάθημα την εβδομάδα",
    perWeekMany: "{n} μαθήματα την εβδομάδα",
    perMonth: "{amount} τον μήνα",
    total: "{n} συνεδρίες σε όλη την περίοδο",
    firstMonth: "Πλήρωσε τον πρώτο μήνα σήμερα και μετά το ίδιο ποσό κάθε μήνα.",
    rule: "Αν ένας μήνας δεν πληρωθεί μέσα σε {days} ημέρες από την ημερομηνία του, οι επερχόμενες κρατήσεις σου απελευθερώνονται για τα άλλα μέλη και οι συνεδρίες σου παγώνουν μέχρι να εξοφληθεί ο μήνας. Τίποτα δεν χάνεται.",
    cta: "Ξεκίνα αυτό το πλάνο",
    signIn: "Συνδέσου για να ξεκινήσεις πλάνο",
    unavailable: "Αυτός ο συνδυασμός δεν είναι διαθέσιμος τώρα.",
  },
  plan: {
    title: "Μηνιαίο πλάνο",
    name: "{months} μήνες · {perWeek} την εβδομάδα",
    monthOf: "Μήνας {n} από {total}",
    paidThrough: "Εξοφλημένο έως {date}",
    dueOn: "Επόμενη πληρωμή στις {date}",
    payBy: "Πλήρωσε έως {date} για να κρατήσεις τις κρατήσεις σου",
    paused: "Σε παύση: ο μήνας δεν έχει πληρωθεί, οι συνεδρίες σου είναι παγωμένες και οι επερχόμενες κρατήσεις απελευθερώθηκαν. Πλήρωσε τον μήνα για να ανοίξουν όλα ξανά.",
    completed: "Η περίοδος ολοκληρώθηκε",
    cancelled: "Το πλάνο τερματίστηκε",
    pay: "Πλήρωσε αυτόν τον μήνα",
    sessionsLeft: "{n} συνεδρίες απομένουν στο πλάνο",
    checkoutFirst: "Πρώτος μήνας του πλάνου σου",
    checkoutRenew: "Μήνας {n} από {total} του πλάνου σου",
    checkoutTerm: "{months} μήνες · {n} συνεδρίες συνολικά",
    checkoutNote: "Το ίδιο ποσό πληρώνεται κάθε μήνα. Μπορείς να πληρώσεις online εδώ ή στο στούντιο.",
  },
  desk: {
    lockedTitle: "Υποδοχή",
    lockedBody:
    ...
    /* ---- η ομάδα, από την υποδοχή ---- */
    /* ---- πακέτα ---- */
    packTitle: "Πακέτα σε πώληση",
    packHelp:
      "Κάθε πακέτο που πωλεί το στούντιο: όνομα, πόσες συνεδρίες, πόσες ημέρες ισχύουν και τιμή καταλόγου. Απενεργοποίησε ένα πακέτο για να φύγει από τη σελίδα τιμών· τα μέλη που το αγόρασαν κρατούν ό,τι έχουν.",
    packNew: "Νέο πακέτο",
    packNameEn: "Όνομα (Αγγλικά)",
    packNameEl: "Όνομα (Ελληνικά)",
    packSessions: "Συνεδρίες",
    packDays: "Ισχύει για (ημέρες)",
    packPrice: "Τιμή (€)",
    packGroup: "Ενότητα στη σελίδα τιμών",
    packGroupSingle: "Μεμονωμένα",
    packGroupMonth: "1 Μήνας",
    packGroupQuarter: "3 Μήνες",
    packGroupPersonal: "Ατομικές και Δυάδες",
    packOn: "Σε πώληση",
    packOff: "Εκτός πώλησης",
    packSwitchOn: "Βάλε σε πώληση",
    packSwitchOff: "Βγάλε από πώληση",
    packDelete: "Διαγραφή",
    packDeleteAsk: "Οριστική διαγραφή του πακέτου {name}; Δεν αναιρείται.",
    packDeleteYes: "Ναι, διαγραφή",
    ...
    planHelp:
      "Μακρά περίοδος με πληρωμή μήνα με μήνα. Όλες οι συνεδρίες μπαίνουν στον λογαριασμό σήμερα· η μηνιαία τιμή είναι το πακέτο ενός μήνα για αυτή τη συχνότητα. Αν ένας μήνας δεν πληρωθεί μέσα σε 3 ημέρες, το πλάνο παγώνει και οι κρατήσεις του απελευθερώνονται.",
    planNone: "Χωρίς πλάνο. Ξεκίνα ένα παρακάτω, με τον πρώτο μήνα πληρωμένο στην υποδοχή.",
    planStart: "Έναρξη πλάνου",
    planMonths: "Μήνες",
    planPerWeek: "Μαθήματα την εβδομάδα",
    planMethod: "Πληρωμή με",
    planCash: "Μετρητά",
    planCard: "Κάρτα στην υποδοχή",
    planRecord: "Καταγραφή πληρωμής μήνα",
    planCancel: "Τερματισμός πλάνου",
    planStarted: "{name}: το πλάνο ξεκίνησε, προστέθηκαν {n} συνεδρίες.",
    planPaid: "{name}: καταγράφηκε ο μήνας {n} από {total}.",
    planCancelled: "{name}: το πλάνο τερματίστηκε.",
    planAllPaid: "Όλοι οι μήνες του πλάνου έχουν πληρωθεί.",
    planAlready: "Το μέλος έχει ήδη πλάνο.",
    planStatusActive: "Ενεργό",
    planStatusLapsed: "Σε παύση, απλήρωτο",
    planStatusPending: "Αναμονή πρώτης πληρωμής",
    planStatusCancelled: "Τερματισμένο",
    planStatusCompleted: "Ολοκληρωμένο",
    planOwing: "Οφείλεται ένας μήνας",
    teamTitle: "Εκπαιδευτές",
    teamHelp:
      "Όποιος είναι εδώ, και ενεργός, εμφανίζεται στη σελίδα του στούντιο και μπορεί να μπει σε μάθημα. Η απόκρυψη τον βγάζει από τη σελίδα και κρατά το όνομά του στα περασμένα μαθήματα. Η διαγραφή τον αφαιρεί οριστικά· τα μαθήματά του μένουν στο πρόγραμμα χωρίς εκπαιδευτή μέχρι να ορίσεις κάποιον.",
    ...
    teamDeleteAsk: "Οριστική διαγραφή του/της {name}; Τα μαθήματα μένουν στο πρόγραμμα χωρίς εκπαιδευτή.",
    teamDeleteYes: "Ναι, διαγραφή",
    ...
    extendTitle: "Επέκταση λήξης",
    extendHelp:
      "Δώσε σε ένα μέλος περισσότερο χρόνο για τις συνεδρίες που ήδη έχει. Διάλεξε το πακέτο και πόσες επιπλέον ημέρες· η νέα ημερομηνία εμφανίζεται πριν πατήσεις.",
    extendBatch: "{left} από {total} · λήγει {date}",
    extendNoExpiry: "χωρίς λήξη",
    extendDays: "Επιπλέον ημέρες",
    extendDo: "Επέκταση",
    extendDone: "{name}: οι συνεδρίες λήγουν πλέον στις {date}.",
    extendNone: "Το μέλος δεν έχει συνεδρίες με ημερομηνία λήξης.",
    /* ---- βασικές τιμές ---- */
    priceBaseTitle: "Τιμοκατάλογος",
    priceBaseHelp:
      "Η κανονική τιμή κάθε πακέτου, πριν από κάθε προσφορά. Άλλαξε έναν αριθμό και αποθήκευσε· η σελίδα τιμών, το ταμείο και τα τιμολόγια ακολουθούν.",
    priceBaseDo: "Αποθήκευση τιμής",
    priceBaseDone: "Η τιμή αποθηκεύτηκε. Ο τιμοκατάλογος άλλαξε παντού.",
    priceBaseEdited: "ορίστηκε από την υποδοχή",
    priceBaseReset: "Επιστροφή στην αρχική τιμή",
    /* ---- κωδικοί προσφοράς ---- */
    promoTitle: "Κωδικοί προσφοράς",
    promoHelp:
      "Κωδικός που πληκτρολογεί το μέλος στο ταμείο για έκπτωση. Κάθε κωδικός ενεργοποιείται και απενεργοποιείται, και μπορεί να περιοριστεί σε χρονικό διάστημα και σε αριθμό χρήσεων.",
    promoCode: "Κωδικός",
    promoKind: "Έκπτωση",
    promoValue: "Ποσό",
    promoFrom: "Ισχύει από",
    promoUntil: "Ισχύει έως",
    promoMaxUses: "Μέγιστες χρήσεις",
    promoMaxUsesHelp: "Κενό για χωρίς όριο",
    promoCreate: "Δημιουργία κωδικού",
    promoCreated: "Ο κωδικός δημιουργήθηκε.",
    promoActive: "Ενεργός",
    promoInactive: "Απενεργοποιημένος",
    promoScheduled: "Δεν έχει ξεκινήσει",
    promoExpired: "Έληξε",
    promoUsedUp: "Εξαντλήθηκε",
    promoEnable: "Ενεργοποίηση",
    promoDisable: "Απενεργοποίηση",
    promoDelete: "Διαγραφή",
    promoDeleted: "Ο κωδικός διαγράφηκε.",
    promoNone: "Δεν υπάρχουν κωδικοί ακόμη.",
    promoUses: "{n} χρήσεις",
    promoExists: "Ο κωδικός υπάρχει ήδη.",
    promoBad: "Έλεγξε τον κωδικό και το ποσό.",
    priceTitle: "Προσφορά",
    priceHelp:
  ...
  auth: {
    ...
    forgotBody: "Γράψε το email με το οποίο έκανες εγγραφή και θα σου στείλουμε σύνδεσμο για να ορίσεις νέο.",
    forgotCta: "Στείλε μου τον σύνδεσμο",
    forgotSentTitle: "Έλεγξε τα εισερχόμενά σου.",
    forgotSentBody: "Αν αυτή η διεύθυνση έχει λογαριασμό σε εμάς, ένα email με σύνδεσμο είναι στον δρόμο του. Ο σύνδεσμος λειτουργεί μία φορά και λήγει σε {n} λεπτά. Αν δεν έρθει τίποτα, δες τον φάκελο ανεπιθύμητων ή δοκίμασε ξανά.",
    forgotNotSent: "Δεν μπορέσαμε να στείλουμε το email αυτή τη στιγμή. Δοκίμασε ξανά σε λίγο ή επικοινώνησε με το στούντιο.",
    resetTitle: "Όρισε νέο κωδικό.",
    resetBody: "Τουλάχιστον 8 χαρακτήρες. Θα τον χρησιμοποιήσεις στην επόμενη σύνδεση.",
    ...
    resetDoneTitle: "Ο κωδικός σου άλλαξε.",
    resetDoneBody: "Μπορείς να συνδεθείς με αυτόν τώρα.",
    resetInvalidTitle: "Αυτός ο σύνδεσμος δεν λειτουργεί πλέον.",
    resetInvalid: "Ο σύνδεσμος δεν είναι έγκυρος. Ζήτησε νέο.",
    resetExpired: "Ο σύνδεσμος έχει λήξει. Οι σύνδεσμοι ισχύουν για {n} λεπτά.",
    resetUsed: "Ο σύνδεσμος έχει ήδη χρησιμοποιηθεί. Αν δεν άλλαξες εσύ τον κωδικό σου, ζήτησε νέο σύνδεσμο.",
    requestNewLink: "Ζήτησε νέο σύνδεσμο",
  ...
  checkoutPage: {
    ...
    promoLabel: "Κωδικός προσφοράς",
    promoPlaceholder: "Γράψε τον κωδικό",
    promoApply: "Εφαρμογή",
    promoApplied: "Ο κωδικός {code} εφαρμόστηκε",
    promoInvalid: "Ο κωδικός δεν ισχύει για αυτό το πακέτο τώρα.",
  ...
  footer: {
    tagline: "Reformer Pilates στη Λάρνακα.",
    explore: "Εξερεύνησε",
    account: "Λογαριασμός",
    visit: "Επισκέψου",
    legal: "Νομικά",
    ...
    partner: "Δύναμη · Ευλυγισία · Κορμός",
...
export const dictionaries: Record<Locale, typeof en> = { en, el, ru };
